      ...
      <div className="px-4 pt-6 pb-20 space-y-6 max-w-3xl mx-auto">
        ...
        <section className="bg-red-50 rounded-lg p-4">
          ...
          <div className="space-y-2">
            ...
            <Typography variant="body2" className="text-gray-700">
              5. 이의 제기는 제재 후 7일 내 support@mateu.co.kr로 가능합니다.
            </Typography>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-2">
            <Typography variant="body2" className="text-gray-700">
              1. 회사는 아동 성적 학대 및 착취(CSAE: Child Sexual Abuse and Exploitation)를 
              포함한 모든 형태의 아동 학대에 대해 무관용 원칙을 적용합니다.
            </Typography>
            <Typography variant="body2" className="text-gray-700">
              2. 다음 행위는 엄격히 금지되며, 위반 시 즉시 계정이 정지되고 
              관련 법 집행 기관에 신고됩니다:
            </Typography>
            <div className="pl-4 space-y-1">
              <Typography variant="body2" className="text-gray-700">
            ...
            <Typography variant="body2" className="text-gray-700">
              3. 아동 보호 관련 의심스러운 행위를 발견한 경우, 
              앱 내 신고 기능 또는 support@mateyou.co.kr로 즉시 신고해 주시기 바랍니다.
            </Typography>
            <Typography variant="body2" className="text-gray-700">
              4. 회사는 신고된 내용을 검토하고, 필요시 관련 법 집행 기관 및 
              NCMEC(National Center for Missing & Exploited Children)에 보고합니다.
            </Typography>
            <Typography variant="body2" className="text-gray-700">
              5. 본 서비스는 만 14세 이상만 이용 가능하며, 미성년자의 안전한 
              서비스 이용을 위해 지속적으로 모니터링합니다.
            </Typography>
          </div>
        </section>
