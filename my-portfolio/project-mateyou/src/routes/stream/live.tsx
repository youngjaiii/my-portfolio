...
export const Route = createFileRoute('/stream/live')({
...
function RouteComponent() {
  ...
  const [initialStreamType, setInitialStreamType] = useState<'audio' | 'video'>('video')
  const [isMobileLiveMode, setIsMobileLiveMode] = useState(false)

  // FAB에서 방송 시작 시트 열기
  const handleOpenCreateSheet = (streamType: 'audio' | 'video' = 'video', mobileMode = false) => {
