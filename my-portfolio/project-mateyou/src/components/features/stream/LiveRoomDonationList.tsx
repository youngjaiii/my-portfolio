/**
 * LiveRoomDonationList - 라이브룸용 오늘 후원 목록 컴포넌트
 * 
 * 라이브룸 스타일: SlideSheet 바텀시트 사용
 * - 후원자별 보기 (인별 정렬)
 * - 시간순 보기 (기록 정렬)
 */
...
interface LiveRoomDonationListProps {
  isOpen: boolean
  onClose: () => void
  roomId: string
}

export function LiveRoomDonationList({
  isOpen,
  onClose,
  roomId,
}: LiveRoomDonationListProps) {
